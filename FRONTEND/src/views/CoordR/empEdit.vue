<template>
  <b-container>
    ...
    <b-row>
      <b-col>
        <br><br>
        <h3>Diligencie el siguiente formulario con los datos del emprendimiento con ID:</h3>
            ...
            <b-container>
              <b-col>
                ...
                <b-form-group id="input-group-2" label="Nit del emprendimiento:" label-for="input-2">
                  <b-form-input id="input-2" v-model="form.nitId" placeholder="NIT" required></b-form-input>
                </b-form-group>
                ...
                <b-form-group id="input-group-2" label="Nombre del Interlocutor:" label-for="input-2">
                  <b-form-input id="input-2" v-model="form.interlocutorEmp" placeholder="Nombre Interlocutor" required>
                  </b-form-input>
                </b-form-group>
              ...
              <b-col>
                ...
                <b-form-group id="input-group-4" label="Productos y servicios:" label-for="input-4">
                  <b-form-input id="input-4" v-model="form.prodServ" placeholder="productos y servicios" required>
                  </b-form-input>
                </b-form-group>
                ...
                <b-form-group id="input-group-4" label="Numero de empleados:" label-for="input-4">
                  <b-form-input id="input-4" v-model="form.empleados" placeholder="Numero de empleados" required>
                  </b-form-input>
                </b-form-group>
                ...
                <b-form-group id="input-group-4" label="Actividad económica:" label-for="input-4">
                  <b-form-input id="input-4" v-model="form.actividadEco" placeholder="Actividad" required>
                  </b-form-input>
                </b-form-group>
                ...
                <b-form-group id="input-group-6" label="horarios de atención a estudiantes:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.horarioAtencion" :options="horario" required>
                  </b-form-select>
                </b-form-group>


                <b-form-group id="input-group-6" label="horarios de disponibildiad:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.disponibilidad" :options="horario" required></b-form-select>
                </b-form-group>

                <b-form-group id="input-group-6" label="Medio de contacto:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.contacto" :options="contacto" required></b-form-select>
                </b-form-group>

                <b-form-group id="input-group-6" label="modalidad de contacto:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.modalidad" :options="modalidad" required></b-form-select>
                </b-form-group>

                <b-form-group id="input-group-6" label="preferencia o restriccion de genero:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.genero" :options="genero" required></b-form-select>
                </b-form-group>


                <b-form-group id="input-group-6" label="Acceso para personas con dificultades:" label-for="input-6">
                  <b-form-select id="input-5" v-model="form.limitacion" :options="sino" required></b-form-select>
                </b-form-group>


                <b-form-group id="input-group-6" label="Es de preferencia asistir con transporte:" label-for="input-6">
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      axios.post("http://localhost:8080/empEdit", {
