            ...
            <b-container>
              ...
              <b-col>
                ...
                <b-form-group id="input-group-4" label="Tema de asesoria:" label-for="input-4">
                    <b-form-select id="input-4" v-model="form.temaAsesorar" :options="tema" required></b-form-select>
                </b-form-group>
...
export default {
  data() {
    return {
      ...
      tema: [{ text: 'Selecione una', value: null }, 'Calidad', 'Seguridad industrial', 'Marketing', 'Recursos humanos', 'Gestión', 'Finanzas', 'Administración', 'Análisis de datos', 'Producción', 'Procesos', 'Sistemas de información'],
